...
const Root = ({
  ...
  return (
    <SelectContext.Provider value={useMemo(() => ({ size }), [size])}>
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <SelectPrimitive.Trigger ref={ref} className={cn(triggerVariants({ size }), className)} {...props}>
      {children}
 ...
 */
const Content = forwardRef<React.ElementRef<typeof SelectPrimitive.Content>, SelectContentProps>(
  (
    {
      className,
      children,
