...
export interface TextProps extends ComponentPropsWithoutRef<"p">, VariantProps<typeof textVariants> {
  asChild?: boolean;
  as?: "p" | "span" | "div";
}
...
const Text = forwardRef<HTMLParagraphElement, TextProps>(
  (
    ...
    return (
      <Component ref={ref} className={cn(textVariants({ size, weight, family, leading }), className)} {...props}>
        {children}
      </Component>
    );
  },
